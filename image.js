...
let opacitySlider = document.getElementById("opacity-slider"); // New element for opacity slider
...
function resetFilter() {
  opacitySlider.value = 1; // Set opacity to 100% initially
...
function addFilter() {
  ...
  sepia(${filterD.value}%) opacity(${opacitySlider.value})`;
}
